package com.suguiura.user.infrastructure.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST,"/users/login").permitAll() // Permite acesso ao endpoint de login sem autenticação
                        .requestMatchers(HttpMethod.GET, "/auth").permitAll()// Permite acesso ao endpoint GET /auth sem autenticação
                        .requestMatchers(HttpMethod.POST, "/users").permitAll() // Permite acesso ao endpoint POST /users sem autenticação
                        .requestMatchers("/users/**").authenticated() // Requer autenticação para qualquer endpoint que comece com /user/
